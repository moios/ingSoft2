...
@NamedQueries({
    ...
    , @NamedQuery(name = "Vacuna.listVacuna", query = "SELECT v.nombre,v.fechaAplicacion FROM Vacuna v WHERE v.idHijo = :idHijo")    
...
public class Vacuna implements Serializable {
    ...
    @JoinColumn(name = "id_hijo", referencedColumnName = "cedula_cod")
    @ManyToOne
    private Hijo idHijo;
    ...
    public String toString() {
        return "com.pediatrica.entidades.Vacuna[ id=" + id + " ]";
    }
